...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://9ebcr4osch.execute-api.us-east-1.amazonaws.com/prod';
    ...
    apigClient.uploadBucketFilenamePut = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['filename', 'bucket', 'Content-Type', 'Accept', 'x-amz-meta-customLabels'], ['body']);
