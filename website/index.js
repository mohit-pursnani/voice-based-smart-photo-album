...
function uploadPhoto() {
    ...
    reader.onload = function() {
        ...
        xhr.open("PUT", "https://**************.amazonaws.com/prod/upload/photo-b/"+data.name);
...
function uploadPhoto2(){
    ...
    reader.onload = function (event) {
        ...
        var requestOptions = {
        method: 'PUT',
        headers: {"x-amz-meta-customLabels" : custom_labels.value.toString(), "Content-Type": type_file_up, "Access-Control-Allow-Headers":"*", "Access-Control-Allow-Methods": "OPTIONS,PUT", "Access-Control-Allow-Origin": "*"},
        body: file,
        redirect: 'follow'
        };
    
        console.log("re headers ====>>>>", requestOptions);
        fetch(`https://********/prod/upload/photo-b/${name_f}`, requestOptions)
